...
<body style="text-align:center;">
    ...
    <div id="header-menu">
        <ul class="menu-list">
            ...
            <li class="menu_item" style="margin-left:2.5%; margin-right:2.5%;"><a class="active" href="publicTasks.php">Public Tasks</a></li>
            <li class="menu_item"><a href="problemsReporting.php">Report Problem</a></li>
        </ul><!--menu-list-->
    </div><!--header-menu-->
    <hr>
    <div class="publicTasks">
        <center><h2>Public Tasks</h2></center>
        <ul class="publicTasksList">
            <?php
                include 'php/publicTasksSelector.php';
            ?>
        </ul><!--publicTasksList-->
